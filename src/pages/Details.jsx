                ...
                <div class="w-full bg-lightpeach rounded-lg shadow sm:max-w-md ">
                    <div class="p-6 space-y-2 md:space-y-4 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            {/* Your Email */}
                            <div>
                                <label for="email" class="block mb-2 text-base font-medium text-black">Your email</label>
                            ...
                            {/* Phone number */}
                            <div>
                                <label for="phone-number" class="block mb-2 text-base font-medium text-black ">Phone Number</label>
                            ...
                            {/* Full Name*/}
                            <div>
                                <label for="full-name" class="block mb-2 text-base font-medium text-black ">Full Name</label>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-base">
                                    <label for="terms" class="font-light text-black ">I accept the <a class="font-medium text-primary-600 hover:underline hover:text-white " href="#">Terms and Conditions</a></label>
                                </div>
                            </div>
                            <div className="flex flex-col justify-center">
                                <a class="px-7 py-3 bg-white/90 text-peach text-center font-semibold text-sm uppercase rounded shadow-md hover:shadow-white hover:bg-white hover:shadow-lg focus:bg-lightpeach focus:shadow-lg active:bg-elightpeach active:shadow-lg transition duration-150 ease-in-out" href="/payment" role="button">next</a>
                            </div>
                        </form>
                    </div>
                </div>
